...
function preload() {
    ...
    quicarSom = loadSound('raquete.wav');
    golSom = loadSound('pontos.wav');
}
...
function draw() {
    ...
    // centralized fundoImagem, with canvas aspectRadio, and zoom out as maximum as possible
    ...
    image(fundoImagem, 0, 0, scaledWidth, scaledHeight);
